...
public interface CouponService {
    ...
    List<Coupon> getAllCoupon(Integer projectId, Integer branchId);
    ...
    List<Map<String,Object>> getCanUseCouponBySome(Integer userId, Integer branchId, Integer proId, BigDecimal MaxMoney);
    //当首页推送优惠券时 根据指定id数组查询优惠券
    List<Coupon> getSomeCouponByIds(List<Integer> ids);
}
