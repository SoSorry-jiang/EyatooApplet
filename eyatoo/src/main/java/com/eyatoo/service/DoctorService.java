...
public interface DoctorService {
    ...
    List<Doctor>  getAllDoctor(List<Integer> idList, String name, String education, String orderBy,
                               Integer distanceId,
                               BigDecimal minlng,
                               BigDecimal maxlng,
                               BigDecimal minlat,
                               BigDecimal maxlat);
    //根据id获得单个医生
    Doctor getOneOfDoctorById(Integer id);
    //获取单个医生所有的标签
    List<DoctorTag> getOneOfDoctorTag(Integer id);
    //获取所有标签
    List<DoctorTag> getAllDoctorTag();
    //医生修改他的默认地址
