...
public interface AccountsService {
    ...
    List<Accounts> getAllClinicOrdersByBranchId(Integer branchId,Integer[] status,Integer outPreId,String appointedTime,String beforeDate,String afterDate);
    ...
    //分页上面的方法
    Page pageAppointedTimeAccounts(Integer typeId, Integer branchId, String beforeDate, String afterDate,Page page);
    ...
    //分页上面的方法
    Page pageFinancialAccounts(Integer branchId,Integer outPreId,Integer forwardStatus,Integer forwardType,String Month,Page page);
